...
def processImage(temp_filename, operation):
    ...
    # Save the processed image with the desired extension
    cv2.imwrite(final_output_filename, imgProcessed)
...
def edit():
    if request.method == 'POST':
        ...
        return send_file(temp_output_filename, mimetype=mime_type)
